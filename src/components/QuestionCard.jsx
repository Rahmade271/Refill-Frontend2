    ...
    const renderConsolidatedFeedback = () => {
            ...
            return (
                ...
                `}>
                    ...
                    <p className="text-sm leading-relaxed ml-9">
                        {questionData.options.find(o => o.is_correct)?.feedback ||
        ...
        return (
            ...
            `}>
                ...
                <p className="text-sm leading-relaxed mb-4 ml-9">
                    Tinjau kembali materi di submodul ini. Pastikan Anda memilih semua opsi yang benar dan tidak memilih opsi yang salah.
                </p>
                ...
                `}>
                    ...
                    <p className="text-sm leading-relaxed ml-8">
                        {hintText || 
                        "Pikirkan fungsinya: Apa yang terlihat pengguna, dan apa yang mengatur data di belakangnya?"}
                    </p>
                </div>
            </div>
        );
                    ...
                    return (
                        ...
                        >
                            <input
                                ...
                                className="mt-0.5 mr-3 h-5 w-5 rounded border-gray-300 text-[var(--blue-primary)] focus:ring-[var(--blue-primary)]"
                            />
