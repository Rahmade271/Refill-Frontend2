  ...
  return (
    <>
      <div
        ...
        "
      >
        {/* WRAPPER: Hapus max-w, biarkan .lc-card yang mengatur */}
        <div className="w-full px-4 sm:px-6">
          
          {/* CARD: Menggunakan struktur .lc-card yang sama dengan halaman lain */}
          <div className="lc-card mx-auto bg-[var(--bg-secondary)] rounded-2xl shadow-xl overflow-hidden border border-[var(--text-primary)]/20">
                      ...
                      <div className="relative w-44 h-44 sm:w-56 sm:h-56">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span
                            className={`
                              text-5xl font-bold
                              ${isPassing ? "text-[var(--green-primary)]" : "text-[var(--red-primary)]"}
                            `}
                          >
                            {percentage}%
                          </span>
